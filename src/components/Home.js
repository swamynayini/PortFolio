  ...
  return (
    <div>
        <div className="p-2 m-2 pl-[3.5rem]">
                ...
                <h1 className="ml-[30rem] mt-[-20rem] text-3xl font-bold text-orange-700">Swamy Nayini</h1>
                <p className="ml-[30rem] mt-[2rem]">Welcome to my portfolio website! I am a passionate and creative front-end developer with a keen eye for detail and a love for crafting stunning user interfaces. With a solid foundation in HTML, CSS, and JavaScript,and React js . I specialize in bringing designs to life, creating seamless and engaging web experiences.</p>
            </div>
            <div className="mt-[12.5rem] ml-[35rem] space-x-4">
